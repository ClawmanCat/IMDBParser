...
namespace IMDBParser {
    ...
    struct ModelActorAppearance : public IDataModel<ModelActorAppearance> {
        ...
        IMDBPARSER_ENUM_CLASS(MediaType,   int, MOVIE, TV_SERIES, MINI_TV_SERIES, UNDEFINED) media_type = MediaType::UNDEFINED;
        IMDBPARSER_ENUM_CLASS(ReleaseType, int, CINEMA, TV, VIDEO, UNDEFINED) release_type = ReleaseType::UNDEFINED;
